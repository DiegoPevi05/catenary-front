...
import { CANTILEVER } from "../assets/images";
...
const CantileverCard = (props:CantileverCard) => {
  ...
  return(
    <>
      ...
      <div className="w-24 h-full p-4 flex justify-center items-center group-active:scale-95 duration-300">
        <img src={CANTILEVER} alt={`icon-menu`}  className="h-full w-full" style={{fill:'currentColor'}}/>
      </div>
